...
- [coherence-gravity-coupling](https://github.com/DawsonInstitute/coherence-gravity-coupling): ⭐ **VALIDATED TABLETOP GRAVITY EXPERIMENT** (Oct 2025) - Coherence-modulated gravitational coupling via non-minimal scalar-tensor field achieving validated τ_coh = 1.4±0.2×10⁻¹² N·m signal with continuum limit Δτ ≈ 2.6×10⁻¹² N·m through Richardson extrapolation. Framework demonstrates macroscopic quantum coherence (BECs, superconductors) reduces effective gravitational coupling G_eff = G/(1 + ξΦ²), eliminating Newtonian backgrounds via null-configuration torsion balance geometry. Convergence validated 61³→81³→101³ resolutions, 41³ artifact systematically corrected. Cryogenic feasibility established: ~1 hour integration at 4K with 10× vibration isolation. Experimental roadmap: $50k-$100k cryogenic torsion balance achieving S/N ~140 for first direct detection of coherence-modulated gravity. Publication-ready LaTeX manuscript targeting Physical Review Letters. **Status**: Computational validation complete, experimental implementation feasible with existing laboratory technology.
