...
- [**lqg-macroscopic-coherence **](https://github.com/arcticoder/lqg-macroscopic-coherence ): ⭐ **FTL NO-GO THEOREM - CLOSED** (Oct 2025) - Rigorous proof that faster-than-light travel is fundamentally impossible within General Relativity + Quantum Field Theory. Exhaustive testing of all viable warp metrics (Alcubierre, Natário, Van Den Broeck) shows 76.9% ANEC violation rates and quantum inequality violations by 10²³× margins. Production-quality implementations: Natário metric validated to 2.6×10⁻⁹ error, Van Den Broeck to 7.8×10⁻¹¹ error, Ford-Roman QI framework, 39 geodesic integrations across 13 null rays. Definitive computational proof closing long-standing question: NO escape routes remain in (3+1)D GR+QFT. Repository serves as reference for why warp drives don't work and redirects future research toward extra-dimensional theories, quantum gravity modifications, or wormhole stability. **Status**: Scientific closure achieved, computational framework preserved for future metric evaluations.
...
- [coherence-gravity-coupling](https://github.com/DawsonInstitute/coherence-gravity-coupling): ⭐ **NULL RESULTS & EXCLUSION LIMITS** (Nov 2025) - Systematic null result study of coherence-gravity coupling ($\xi R\Phi^2$) and curvature-EM interactions ($\kappa_R R F^2$) yielding quantitative exclusion limits from laboratory-scale parameter sweeps. Framework tests coupling strengths ξ∈{50,100}, coherent materials (Rb-87 BEC, Nb cavity, YBCO cuprate with Φ₀ = 3.65×10⁶ to 6.67×10⁸ m⁻¹), and magnetic fields B∈[0.5,10]T. All configurations yield null signals consistent with numerical baseline (|Δτ| ≈ 5×10⁻¹³ N·m), constraining curvature-EM coupling to κ_R < 5×10¹⁷ m² at B=10T, terrestrial Ricci curvature R=10⁻²⁶ m⁻², precision δ=10⁻⁶. Companion validation study demonstrates τ_coh = 1.4±0.2×10⁻¹² N·m via convergence analysis (61³→81³→101³), establishing cryogenic feasibility (~1 hour integration, 4K, 10× isolation). Dual manuscripts: null results paper with exclusion limits (arXiv-ready), validation paper documenting computational framework (Physical Review Letters track). Open-source pipeline with timestamped data (JSON), plots (PNG/PDF), and consolidated tables (CSV/LaTeX). **Status**: Publication-ready null results establish quantitative bounds on beyond-GR couplings; companion validation study confirms experimental feasibility.
- [energy-tensor-cone](https://github.com/DawsonInstitute/energy-tensor-cone): ⭐ **SUBMITTED TO PHYSICAL REVIEW D** (Feb 2026) - Hybrid formal/computational study of the convex geometry of stress-energy tensors satisfying Averaged Quantum Energy Inequalities (AQEI). Combines Lean 4 formal proofs (35 theorems proven, 17 modules, Mathlib) with a Mathematica LP search and exact rational arithmetic certification (6×6 determinant via native_decide on GMP arithmetic). Key results: closure and convexity of AQEI-admissible sets mechanically verified; extreme ray of the finite-dimensional feasibility polytope identified and formally certified. Full reproducible pipeline: Mathematica → Python → Lean. **DOI**: [10.5281/zenodo.18522456](https://doi.org/10.5281/zenodo.18522456); dataset: [10.5281/zenodo.18727839](https://doi.org/10.5281/zenodo.18727839).
